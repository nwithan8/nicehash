...
def private_api_request(func):
    ...
    def wrapper(self, *args, **kwargs) -> dict:
        ...
        header = utils.get_encoded_header(obj=self, method=method, path=endpoint, query=query, body=body)
        url = api_requests.make_url(base=self._url, endpoint=endpoint)
...
class PrivateAPI:
    ...
    def exchange_orders(self, market) -> dict:
        ...
        return "bool", "get", '/exchange/api/v2/myOrders', params, None
    ...
    def exchange_trades(self, market) -> dict:
        ...
        return "bool", "get", '/exchange/api/v2/myTrades', params, None
